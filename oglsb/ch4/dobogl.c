...
GLfloat* dglMultiply44f4f(GLfloat * A, GLfloat * v) {
	GLfloat* ret = (GLfloat *)malloc((sizeof GLfloat) * 4);
	ret[0] = A[0]*v[0]+A[4]*v[1]+A[8]*v[2];
	ret[1] = A[1]*v[0]+A[5]*v[1]+A[9]*v[2];
	ret[2] = A[2]*v[0]+A[6]*v[1]+A[10]*v[2];
	ret[3] = A[3]*v[0]+A[7]*v[1]+A[11]*v[2];
	return ret;
}
